...
public class Brontosaurus extends Dinosaur
{
    ...
    /**
     * Constructor for objects of class Brontosaurus
     */
    public Brontosaurus()
    {
    ...
    public boolean attack(Dinosaur other)
    {
        ...
        if (other.getType().equals("Brontosaurus")&& other.getHealth()!=0 && this.equals(other) == false)
        {
            if (Math.random() > 0.5)
                result = true;
        }
        ...
        else if (other.getType().equals("Pterodactyl")&& other.getHealth()!=0 && this.equals(other) == false)
        {
            if (Math.random() > 0.25)
                result = true;
        }
